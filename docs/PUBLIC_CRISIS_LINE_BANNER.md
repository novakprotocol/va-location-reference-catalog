...
The banner is intentionally locked to the top of the viewport:

- `position: fixed`
- `top: 0`
- high `z-index`
- automatic body/header offset so page content does not hide underneath it

This means the banner remains visible while scrolling public pages.
